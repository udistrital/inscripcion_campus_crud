...
func run_bee() {
	parametros := "INSCRIPCION_CAMPUS_CRUD_HTTP_PORT=" + beego.AppConfig.String("httpport") + "INSCRIPCION_CAMPUS_CRUD__PGUSER=" + beego.AppConfig.String("PGuser") + " INSCRIPCION_CAMPUS_CRUD__PGPASS=" + beego.AppConfig.String("PGpass") + " INSCRIPCION_CAMPUS_CRUD__PGURLS=" + beego.AppConfig.String("PGurls") + " INSCRIPCION_CAMPUS_CRUD__PGDB=" + beego.AppConfig.String("PGdb") + " INSCRIPCION_CAMPUS_CRUD__SCHEMA=" + beego.AppConfig.String("PGschemas") + " bee run"
